...
var style_IRI2024_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("IRI 2024");
    ...
    if (value >= 0.000000 && value <= 4.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
            ...
            style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(255,149,1,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2.508}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })]
                    } else if (value >= 12.000000 && value <= 1000.000000) {
            style = [ new ol.style.Style({
