...
map.getView().fit([12930313.947309, 258632.536636, 13223900.066625, 478115.030460], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Data Rating Kondisi Jalan Nasional Kalimantan Utara</h2>';
        return titleElement;
    })(),
